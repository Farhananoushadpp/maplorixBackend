...
const fixTutu3Application = async () => {
  try {
    // Connect to MongoDB
    ...
    const application = await Application.findOne({ fullName: 'tutu3' });
    
    if (application) {
      console.log('📋 Found Application (tutu3):');
      ...
      console.log('❌ Application not found with name: tutu3');
    }
