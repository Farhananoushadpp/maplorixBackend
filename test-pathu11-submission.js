...
const testPathu11Submission = async () => {
  try {
    console.log('🔧 Testing pathu11 application submission...');
    
    // Create form data exactly like the frontend
    const formData = new FormData();
    formData.append('fullName', 'pathu11');
    ...
    formData.append('coverLetter', 'fxdfgfhdfhdfhdfhfh');
    formData.append('status', 'pending');
    formData.append('source', 'website');
    formData.append('name', 'pathu11');
    formData.append('position', 'graphic designer');
    
    // Create a simple PDF file for testing
    const pdfContent = new Blob(['%PDF-1.4\n1 0 obj\n<<\n/Type /Catalog\n/Pages 2 0 R\n>>\nendobj\n2 0 obj\n<<\n/Type /Pages\n/Kids [3 0 R]\n/Count 1\n>>\nendobj\n3 0 obj\n<<\n/Type /Page\n/Parent 2 0 R\n/MediaBox [0 0 612 792]\n/Resources <<\n/Font <<\n/F1 4 0 R\n>>\n>>\n/Contents 5 0 R\n>>\nendobj\n4 0 obj\n<<\n/Type /Font\n/Subtype /Type1\n/BaseFont /Helvetica\n>>\nendobj\n5 0 obj\n<<\n/Length 44\n>>\nstream\nBT /F1 12 Tf 72 720 Td (pathu11 Resume Test) Tj ET\nendstream\nendobj\nxref\n0 6\n0000000000 65535 f \n0000000009 00000 f \n0000000074 00000 f \n0000000120 00000 f \n0000000179 00000 f \n0000000224 00000 f \ntrailer\n<<\n/Size 6\n/Root 1 0 R\n>>\nstartxref\n295\n%%EOF'], { type: 'application/pdf' });
    formData.append('resume', pdfContent, 'dummy_resume_john_doe.pdf');
    ...
    if (response.data.success && response.data.data && response.data.data.application.resume) {
      ...
      console.log('📱 Now the dashboard should show the resume!');
